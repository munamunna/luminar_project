...
router.register('api/register',views.CustomAdminView,basename="users")
router.register('api/student/register',views.StudentView,basename="students")
router.register('api/waitinglists',views.WaitingListView,basename="waitinglists")
