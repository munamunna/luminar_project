...
from app.models import CustomAdmin,WaitingList
...
from app.models import CustomAdmin,Student,Batch,AddStudent
from app.serializers import CustomUserSerializer,StudentSerializer,WaitingListSerializer,AddStudentSerializer,BatchSerializer
